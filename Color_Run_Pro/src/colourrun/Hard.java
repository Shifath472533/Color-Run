...
import static colourrun.Medium.flag;
...
/**
 * This class contains the level "Hard" in the main game
 *
...
public class Hard extends Application {
    ...
    AudioClip col;
    static int score = 0, life = 31, flag, flag1;
    Label lifelabel = new Label();
    static int f = 0, a = 1, w = 0;
    ...
    public void start(Stage stage) {
        ...
        Image image1 = new Image(Hard.class.getResourceAsStream("back1.png"));
        Image image2 = new Image(Hard.class.getResourceAsStream("back2.png"));
         ...
         */
        timeline3 = new Timeline(new KeyFrame(Duration.millis(4), e2 -> {
            background++;
            if (background >= 800) {
                background = -800;
            }
        ...
        timeline3.play();
        List<Color> colors6 = Arrays.asList(Color.RED, Color.GREEN, Color.BLUE, Color.YELLOW, Color.CORNFLOWERBLUE, Color.DARKCYAN);
        List<Color> colors7 = Arrays.asList(Color.RED, Color.GREEN, Color.BLUE, Color.YELLOW, Color.CORNFLOWERBLUE, Color.DARKCYAN, Color.AQUAMARINE);
        ...
        JFXButton restartButton = new JFXButton("Play Again");
        ...
        JFXButton quittomainmenuButton = new JFXButton("Quit to Main Menu");
            ...
            public void handle(ActionEvent event) {
                ...
                if (lost) {
                    ...
                    if (life <= 31 && life >= 21) {
                        f = 1;
                        lifelabel.setText("**");
                    } else if (life < 21 && life >= 11) {
                        f = 1;
                        lifelabel.setText("*");
                    } else if (life < 11 && life >= 1) {
                        f = 1;
                        lifelabel.setText("");
                    } else if (life < 1) {
                        lostAction();
